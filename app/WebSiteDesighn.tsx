...
// const WebSiteDesighn = () => {
//     return (


//         <div className="p-4 mx-auto relative z-10 w-full pt-20 md:pt-32">

//             <div className="text-4xl pb-5 md:text-7xl px-6 text-center bg-clip-text text-transparent bg-gradient-to-b from-purple-500 to bg-sky-100 bg-opacity-50">
